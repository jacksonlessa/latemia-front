    ...
    items: [
      {
        ...
        rating: 5,
        quote: 'A equipe é extremamente atenciosa e cuidadosa. Senti que a Mel estava em boas mãos do primeiro minuto. Explicaram cada passo do atendimento com paciência e carinho.',
      },
      {
        petName: 'Thor',
        tutorName: 'Carlos M.',
        rating: 5,
        quote: 'Clínica organizada, limpa e com profissionais muito preparados. O Dr. e a equipe trataram o Thor com o mesmo carinho que eu trataria. Atendimento humano de verdade.',
      },
      {
        petName: 'Luna',
        tutorName: 'Fernanda R.',
        rating: 4,
        quote: 'Estrutura excelente e atendimento ágil. A Luna sempre fica tranquila durante as consultas — isso só acontece quando o ambiente e as pessoas transmitem confiança.',
      },
    ],
  },
