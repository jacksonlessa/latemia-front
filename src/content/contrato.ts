 ...
 */
export const CONTRACT_EFFECTIVE_DATE = '2026-05-19';
...
(i) **diretamente** em canal oficial de Atendimento ao Consumidor (SAC) da CONTRATADA — e-mail **sac@drcleitinho.com.br**, WhatsApp ou telefone; ou
(ii) mediante **link público de confirmação** enviado por atendente da CONTRATADA, com validade de **7 (sete) dias** — após esse prazo o link expira automaticamente, e novo link gerado invalida o anterior.
...
(iii) **conduta desrespeitosa, agressiva ou discriminatória** comprovada de VOCÊ contra a equipe da CLÍNICA — assegurado contraditório por **15 (quinze) dias**, salvo em caso de violência atual ou risco iminente;
(iv) **descumprimento reiterado** de obrigações destes TERMOS;
(v) **descontinuação do PLANO** — com aviso prévio mínimo de **30 (trinta) dias** e reembolso de eventuais valores cobrados antecipadamente em desacordo.
...
**14.2.** O tratamento de dados pessoais é regido pela **[Política de Privacidade da Late&Mia Clínica Veterinária](https://plano.drcleitinho.com.br/privacidade)**, **parte integrante destes TERMOS**, disponível em \`https://plano.drcleitinho.com.br/privacidade\`.
