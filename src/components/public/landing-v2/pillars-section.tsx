...
const items: PillarItem[] = [
  {
    ...
    description:
      'Descontos em consultas, exames e procedimentos de rotina realizados na clínica. Ideal para quem quer cuidar melhor do pet ao longo do ano.',
    badge: 'immediate',
    icon: (
  ...
  },
  {
    ...
    description:
      'Canal para tirar dúvidas antes ou durante uma situação de preocupação com o pet, em horário usual das 07h às 23h, conforme disponibilidade da equipe.',
    badge: 'immediate',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
  ...
  },
  {
    ...
    description:
      'Após 180 dias de carência, o pet cadastrado tem 50% de desconto no atendimento emergencial realizado na clínica, durante a fase aguda do quadro.',
    badge: 'after-waiting',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      ...
      <div className="mx-auto w-full max-w-[1120px] px-5">
        <div className="flex flex-col gap-2.5">
          ...
          <h2 className="font-display text-[clamp(28px,7vw,42px)] leading-[1.05] tracking-[-0.03em] text-ink">
            Um plano simples, com três benefícios claros.
          </h2>
          <p className="max-w-[640px] text-[15px] leading-[1.55] text-ink-soft">
            Você não precisa esperar uma emergência para começar a aproveitar. Parte
            dos benefícios já fica disponível após a confirmação do primeiro pagamento.
          </p>
        </div>
